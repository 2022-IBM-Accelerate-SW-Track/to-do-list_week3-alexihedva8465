...
const Todos = ({ todos, deleteTodo }) => {
  const todoList = todos.length ? (
    todos.map((todo) => {
      ...
      return (
        <Grid key={todo.id}>
          <Card style={{marginTop:10, background:color}} data-testid="new-date-item">
            ...
            <ListItemButton component="a" href="#simple-list">
              <Checkbox style={{paddingLeft:0}} data-testid="checkbox-item" color="primary" onClick={() => deleteTodo(todo.id)}/>
